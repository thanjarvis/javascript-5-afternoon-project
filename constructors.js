...
User.prototype.removeSavedPost = function(id){
  let killPost = this.savedPosts.findIndex(element => element.id === id)
  this.savedPosts.splice(killPost, 1)
...
User.prototype.changePostRating = function(id, rating){
  let selectedPost = this.savedPosts.findIndex(element => element.id === id)
  this.savedPosts[selectedPost].rating = rating
  return this.savedPosts
}